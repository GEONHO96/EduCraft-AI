/**
 * LoginPage - 로그인 페이지 (리뉴얼)
 * 좌측 브랜딩 패널 + 우측 로그인 폼의 스플릿 레이아웃
            ...
            {[
              {
                ...
                title: 'AI 커리큘럼 자동 생성',
                desc: '과목과 주차를 입력하면 AI가 체계적인 교육과정을 설계합니다',
              ...
              <div
                key={idx}
                className="flex items-start gap-3.5 bg-white/[0.04] backdrop-blur-sm rounded-xl p-3.5 border border-white/[0.06] hover:bg-white/[0.07] transition-colors"
              >
                <div className={`w-9 h-9 shrink-0 rounded-lg bg-gradient-to-br ${feature.color} bg-opacity-20 flex items-center justify-center`}>
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-indigo-200/40 leading-relaxed mt-0.5">{feature.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="w-full max-w-[420px]">
          ...
          <div className="grid grid-cols-3 gap-3 mb-6">
            <button
              ...
              className="flex items-center justify-center gap-2 h-11 border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all duration-200 group"
            >
              ...
              <span className="text-sm font-medium text-gray-600 hidden sm:block">Google</span>
            </button>

            <button
              onClick={handleKakaoLogin}
              className="flex items-center justify-center gap-2 h-11 rounded-xl hover:opacity-90 transition-all duration-200"
            ...
            >
              ...
              <span className="text-sm font-medium hidden sm:block" style={{ color: '#3C1E1E' }}>Kakao</span>
            </button>

            <button
              onClick={handleNaverLogin}
              className="flex items-center justify-center gap-2 h-11 rounded-xl hover:opacity-90 transition-all duration-200 text-white"
              style={{ backgroundColor: '#03C75A' }}
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24">
                <path fill="#fff" d="M16.273 12.845 7.376 0H0v24h7.727V11.155L16.624 24H24V0h-7.727z"/>
              </svg>
              <span className="text-sm font-medium hidden sm:block">Naver</span>
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 outline-none transition-all duration-200 placeholder:text-gray-300"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-11 py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-400 outline-none transition-all duration-200 placeholder:text-gray-300"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-11 bg-gradient-to-r from-indigo-600 to-violet-600 text-white text-sm font-semibold rounded-xl hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 shadow-sm shadow-indigo-500/20 flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
